# -*- coding: utf-8 -*-
"""Báo cáo đồ án kpdl bản mới Rule base.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/178n6jJUsY6QXmhkCJ0yUDHUf9cAWPRDn
"""
...
# TRUY VẤN
# ==============================
query = "Tốn bao nhiêu tiền để đăng ký thường trú trực tiếp?"
...
PHẠM VI ÁP DỤNG:
- Chỉ tư vấn các nội dung LIÊN QUAN ĐẾN thủ tục hỗ trợ cư trú (ví dụ: đăng ký thường trú, đăng ký tạm trú, lệ phí đăng ký thường trú, trình tự thực hiện, thời hạn giải quyết, thành phần hồ sơ, cách thức thực hiện, yêu cầu biểu mẫu, thời hạn giải quyết).
